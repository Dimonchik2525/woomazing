(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-left")) new core(".slider-left", {
        ...
        if (document.querySelector(".slider-right")) new core(".slider-right", {
        ...
        if (document.querySelector(".dream-team__slider")) new core(".dream-team__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
